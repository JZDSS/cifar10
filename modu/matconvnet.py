...
def deepnn(x):
    ...
    with tf.variable_scope('conv5'):
        W_conv5 = weight_variable_v2([1, 1, 64, 10], 0.05)
        # variable_summaries(W_conv5, 'weights')
        b_conv5 = bias_variable_v2([10], 0.0)
